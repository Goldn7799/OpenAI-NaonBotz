...
async function takeScreenshotWeb (rUrl, outputPath) {
  const url = (rUrl.includes('http://') || rUrl.includes('https://')) ? rUrl : `https://${rUrl}`
  const browser = await puppeteer.launch({
    executablePath: config.bot.puppeteerPath
  })
