...
setInterval(() => {
  ...
  dataStatsHistory.push([`${utility.timeParse(date.getHours(), date.getMinutes())}`, (Object.keys(database.chats)).length, (Object.keys(database.groups)).length], database.state.openaiLimit)
}, 300000)
